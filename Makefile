...
lint-py:  ## lint python with ruff
	python -m ruff check ccflow_rest
	python -m ruff format --check ccflow_rest
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ccflow_rest
	python -m ruff format ccflow_rest
...
test:  ## run python tests
	python -m pytest -v ccflow_rest/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ccflow_rest/tests --cov=ccflow_rest --cov-report term-missing --cov-report xml
